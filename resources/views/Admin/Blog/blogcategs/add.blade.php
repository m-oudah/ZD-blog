		...
		<div class="col-lg-8">
			<div class="page-header-title">
				...
				<div class="d-inline">
					...
					<span>Add Blog Category Type</span>
				</div>
			</div>
		</div>
		<div class="col-lg-4">
			<div class="page-header-breadcrumb">
				<ul class=" breadcrumb breadcrumb-title">
					...
					<li class="breadcrumb-item">
                        <a href="{{route('add.Admin.blogcateg')}}">
                            Blog Categories
                        </a>
					</li>
					<li class="breadcrumb-item">
							...
							<div class="card-block">
								<form id="number_form" method="post" enctype="multipart/form-data">
									...
									<div class="form-group row">
										<label class="col-sm-2 col-form-label">EN Category</label>
										<div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">AR Category</label>
                                        <div class="col-sm-10">
									...
									<div class="form-group row">
                                        <label class="col-sm-2 col-form-label">BA Category</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="baName" id="less"
                                                   placeholder="AR Name" value="{{ old('baName') }}" required>
                                            <span class="messages"></span>
                                        </div>
                                    </div>
