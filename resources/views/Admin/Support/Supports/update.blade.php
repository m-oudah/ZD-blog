		...
		<div class="col-lg-8">
			<div class="page-header-title">
				...
				<div class="d-inline">
					...
					<span>Update Support Topic</span>
				</div>
			</div>
		</div>
		<div class="col-lg-4">
			<div class="page-header-breadcrumb">
				<ul class=" breadcrumb breadcrumb-title">
					...
					<li class="breadcrumb-item">
                        <a href="{{route('index.Admin.support')}}">
                            Support Topics
                        </a>
					</li>
					<li class="breadcrumb-item">
					...
					<div class="col-sm-12">
						...
						<div class="card">
							<div class="card-header">
								<h5>Update Support Topic</h5>

							</div>
							<div class="card-block">
								<form id="number_form" method="post" enctype="multipart/form-data" action="{{ route('update.Admin.support',$support->id) }}">
									@csrf
                                    @method('POST')
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control {{ ($errors->has('enTitle')) ? 'is-invalid' : '' }} " name="enTitle" id="less"
                                                   placeholder="en Title" value=" {{ old('enTitle', $support->enTitle) }} " required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control {{ ($errors->has('arTitle')) ? 'is-invalid' : '' }}" name="arTitle" id="less"
                                                   placeholder="ar Title" value=" {{ old('arTitle',$support->arTitle) }} " required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control {{ ($errors->has('enInfo')) ? 'is-invalid' : '' }}" name="enInfo" id="" cols="30" rows="10" required>{{ old('enInfo',$support->enInfo) }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control {{ ($errors->has('arInfo')) ? 'is-invalid' : '' }}" name="arInfo" id="" cols="30" rows="10" required>{{ old('arInfo',$support->arInfo) }}</textarea>
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											...
											<select name="sectionID" class="myselect" style="width: 100%;">
												...
												<option value="{{$sec->id}}"
                                                {{ ($sec->id ==$support->sectionID) ?  "selected" : '' }}
                                                >
